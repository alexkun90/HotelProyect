...
<div class="container mt-4">
    <form action="procesar_formulario.php" method="post" style="max-width: 600px; margin: 0 auto; margin-top: 20px; margin-bottom: 40px; border: 2px solid rgba(235, 204, 110, 0.5); border-radius: 10px; padding: 20px;">
